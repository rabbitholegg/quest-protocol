...
describe('Merkle Distributor contract', function () {
    ...
    describe('setToken', () => {
        it('should allow an admin to set the token', async function () {
            const {hardhatToken, owner} = await loadFixture(deployTokenFixture)
            const tokenContractAddress = await hardhatToken.token()
            expect(tokenContractAddress).to.equal('0x0000000000000000000000000000000000000000')
            await hardhatToken.setToken('0x0000000000000000000000000000000000000001')
            expect(tokenContractAddress).to.equal('0x0000000000000000000000000000000000000001')
        })
        it('Deployment should set the correct owner address', async function () {
            const {hardhatToken, owner} = await loadFixture(deployTokenFixture)
            expect(await hardhatToken.owner()).to.equal(owner.address)
    ...
    describe('Deploy and transfer rewards', function () {
        ...
        it('Deployment should mint and transfer reward token to disperse contract', async function () {
            const {
                hardhatDisperseToken,
                disperseTokenAddresss,
                hardhatRewardToken,
                rewardTokenAddress
            } = await loadFixture(
